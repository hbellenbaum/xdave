...
def test_carbon_ff():
    ...
    plt.plot(c0[:, 0], c0[:, 1], label="Test data: C0", ls=":", c="navy", alpha=0.7, marker="x", markevery=20)
    plt.plot(c1[:, 0], c1[:, 1], label="Test data: C1", ls=":", c="dodgerblue", alpha=0.7, marker="x", markevery=20)
    plt.plot(c2[:, 0], c2[:, 1], label="Test data: C2", ls=":", c="lightgreen", alpha=0.7, marker="x", markevery=20)
    plt.plot(c3[:, 0], c3[:, 1], label="Test data: C3", ls=":", c="orange", alpha=0.7, marker="x", markevery=20)
    plt.plot(c4[:, 0], c4[:, 1], label="Test data: C4", ls=":", c="crimson", alpha=0.7, marker="x", markevery=20)
    plt.plot(c5[:, 0], c5[:, 1], label="Test data: C5", ls=":", c="magenta", alpha=0.7, marker="x", markevery=20)
    plt.legend()
