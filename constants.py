...
FINE_STRUCTURE_CONSTANT = (
    ELEMENTARY_CHARGE_SQR * COULOMB_CONSTANT / (DIRAC_CONSTANT * SPEED_OF_LIGHT)
)
FINE_STRUCTURE_CONSTANT_SQR = FINE_STRUCTURE_CONSTANT * FINE_STRUCTURE_CONSTANT

# Bohr radius (of an electron) in units of m.
BOHR_RADIUS = DIRAC_CONSTANT / (
    FINE_STRUCTURE_CONSTANT * ELECTRON_MASS * SPEED_OF_LIGHT
)

# Rdberg constant in units of 1/m.
RYDBERG_CONSTANT = (
    0.5 * FINE_STRUCTURE_CONSTANT_SQR * ELECTRON_MASS * SPEED_OF_LIGHT / PLANCK_CONSTANT
)
...
CLASSICAL_ELECTRON_RADIUS = (
    ELEMENTARY_CHARGE_SQR * COULOMB_CONSTANT / (ELECTRON_MASS * SPEED_OF_LIGHT_SQR)
)

# Thomson cross section in units of m^2.
THOMSON_CROSS_SECTION = (
    2.0 * FOUR_THIRDS_PI * CLASSICAL_ELECTRON_RADIUS * CLASSICAL_ELECTRON_RADIUS
)
